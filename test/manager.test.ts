...
import { MobileDevice } from '../src/model/models';
...
let  samplePublication: models.Publication = {
	"topic": "sampletopic",
	"range": 300,
	"duration": 60,
...
let sampleDevice: MobileDevice = new MobileDevice(){
	name : "test",
	platform : "iOS",
...
describe('Manager', function () {
    describe('#instanciation', function () {
        it('should allow being instanciated with an apiKey', function () {
            var mgr = new Manager(apiKey, apiLocation);
