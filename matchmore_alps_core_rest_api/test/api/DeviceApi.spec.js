...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(root.expect, root.MatchmoreAlpsCoreRestApi);
  }
}(this, function(expect, MatchmoreAlpsCoreRestApi) {
  'use strict';

  var instance;

  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.DeviceApi();
  });
  ...
  describe('DeviceApi', function() {
    ...
    describe('getIBeaconTriples', function() {
      it('should call getIBeaconTriples successfully', function(done) {
        //uncomment below and update the code to test getIBeaconTriples
        //instance.getIBeaconTriples(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('triggerProximityEvents', function() {
      it('should call triggerProximityEvents successfully', function(done) {
        //uncomment below and update the code to test triggerProximityEvents
        //instance.triggerProximityEvents(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
