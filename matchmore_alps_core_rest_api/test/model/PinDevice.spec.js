...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.PinDevice();
  });
  ...
  describe('PinDevice', function() {
    it('should create an instance of PinDevice', function() {
      // uncomment below and update the code to test PinDevice
      //var instane = new MatchmoreAlpsCoreRestApi.PinDevice();
      //expect(instance).to.be.a(MatchmoreAlpsCoreRestApi.PinDevice);
    });
