...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.Subscription();
  });
  ...
  describe('Subscription', function() {
    it('should create an instance of Subscription', function() {
      ...
      //var instane = new MatchmoreAlpsCoreRestApi.Subscription();
      //expect(instance).to.be.a(MatchmoreAlpsCoreRestApi.Subscription);
    });
    ...
    it('should have the property pushers (base name: "pushers")', function() {
      // uncomment below and update the code to test the property pushers
      //var instane = new MatchmoreAlpsCoreRestApi.Subscription();
      //expect(instance).to.be();
    });
