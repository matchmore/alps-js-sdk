...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.Matches();
  });
  ...
  describe('Matches', function() {
    it('should create an instance of Matches', function() {
      // uncomment below and update the code to test Matches
      //var instane = new MatchmoreAlpsCoreRestApi.Matches();
      //expect(instance).to.be.a(MatchmoreAlpsCoreRestApi.Matches);
    });
