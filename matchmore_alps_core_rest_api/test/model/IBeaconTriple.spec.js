...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.IBeaconTriple();
  });
  ...
  describe('IBeaconTriple', function() {
    it('should create an instance of IBeaconTriple', function() {
      // uncomment below and update the code to test IBeaconTriple
      //var instane = new MatchmoreAlpsCoreRestApi.IBeaconTriple();
      //expect(instance).to.be.a(MatchmoreAlpsCoreRestApi.IBeaconTriple);
    });
