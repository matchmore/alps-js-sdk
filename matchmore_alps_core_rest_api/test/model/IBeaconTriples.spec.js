...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.IBeaconTriples();
  });
  ...
  describe('IBeaconTriples', function() {
    it('should create an instance of IBeaconTriples', function() {
      // uncomment below and update the code to test IBeaconTriples
      //var instane = new MatchmoreAlpsCoreRestApi.IBeaconTriples();
      //expect(instance).to.be.a(MatchmoreAlpsCoreRestApi.IBeaconTriples);
    });
