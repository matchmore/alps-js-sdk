...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.Devices();
  });
  ...
  describe('Devices', function() {
    it('should create an instance of Devices', function() {
      // uncomment below and update the code to test Devices
      //var instane = new MatchmoreAlpsCoreRestApi.Devices();
      //expect(instance).to.be.a(MatchmoreAlpsCoreRestApi.Devices);
    });
