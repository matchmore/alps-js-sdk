...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.Publication();
  });
  ...
  describe('Publication', function() {
    it('should create an instance of Publication', function() {
      ...
      //var instane = new MatchmoreAlpsCoreRestApi.Publication();
      //expect(instance).to.be.a(MatchmoreAlpsCoreRestApi.Publication);
    });
