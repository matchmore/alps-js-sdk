...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.Subscriptions();
  });
  ...
  describe('Subscriptions', function() {
    it('should create an instance of Subscriptions', function() {
      ...
      //var instane = new MatchmoreAlpsCoreRestApi.Subscriptions();
      //expect(instance).to.be.a(MatchmoreAlpsCoreRestApi.Subscriptions);
    });
