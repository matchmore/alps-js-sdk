...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.Publications();
  });
  ...
  describe('Publications', function() {
    it('should create an instance of Publications', function() {
      // uncomment below and update the code to test Publications
      //var instane = new MatchmoreAlpsCoreRestApi.Publications();
      //expect(instance).to.be.a(MatchmoreAlpsCoreRestApi.Publications);
    });
