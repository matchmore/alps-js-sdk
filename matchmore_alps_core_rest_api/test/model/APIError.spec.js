...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.APIError();
  });
  ...
  describe('APIError', function() {
    it('should create an instance of APIError', function() {
      ...
      //var instane = new MatchmoreAlpsCoreRestApi.APIError();
      //expect(instance).to.be.a(MatchmoreAlpsCoreRestApi.APIError);
    });
