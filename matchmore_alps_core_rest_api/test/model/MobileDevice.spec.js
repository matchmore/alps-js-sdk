...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.MobileDevice();
  });
  ...
  describe('MobileDevice', function() {
    it('should create an instance of MobileDevice', function() {
      // uncomment below and update the code to test MobileDevice
      //var instane = new MatchmoreAlpsCoreRestApi.MobileDevice();
      //expect(instance).to.be.a(MatchmoreAlpsCoreRestApi.MobileDevice);
    });
