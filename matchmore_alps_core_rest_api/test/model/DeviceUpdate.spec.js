...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.DeviceUpdate();
  });
  ...
  describe('DeviceUpdate', function() {
    it('should create an instance of DeviceUpdate', function() {
      ...
      //var instane = new MatchmoreAlpsCoreRestApi.DeviceUpdate();
      //expect(instance).to.be.a(MatchmoreAlpsCoreRestApi.DeviceUpdate);
    });
