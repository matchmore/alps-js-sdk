...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.ProximityEvent();
  });
  ...
  describe('ProximityEvent', function() {
    it('should create an instance of ProximityEvent', function() {
      // uncomment below and update the code to test ProximityEvent
      //var instane = new MatchmoreAlpsCoreRestApi.ProximityEvent();
      //expect(instance).to.be.a(MatchmoreAlpsCoreRestApi.ProximityEvent);
    });
