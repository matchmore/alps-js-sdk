...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.Location();
  });
  ...
  describe('Location', function() {
    it('should create an instance of Location', function() {
      ...
      //var instane = new MatchmoreAlpsCoreRestApi.Location();
      //expect(instance).to.be.a(MatchmoreAlpsCoreRestApi.Location);
    });
