...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MatchmoreAlpsCoreRestApi.IBeaconDevice();
  });
  ...
  describe('IBeaconDevice', function() {
    it('should create an instance of IBeaconDevice', function() {
      // uncomment below and update the code to test IBeaconDevice
      //var instane = new MatchmoreAlpsCoreRestApi.IBeaconDevice();
      //expect(instance).to.be.a(MatchmoreAlpsCoreRestApi.IBeaconDevice);
    });

    it('should have the property proximityUUID (base name: "proximityUUID")', function() {
      // uncomment below and update the code to test the property proximityUUID
      //var instane = new MatchmoreAlpsCoreRestApi.IBeaconDevice();
